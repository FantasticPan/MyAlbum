...
<head>
    ...
    <link href="//cdn.bootcss.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet">    <!--[if lt IE 9]>
        ...
        <c:when test="${status.first or status.index % 4 eq 0}">
            ...
            <div class="col-xs-2 col-xs-offset-2">
                <a href="#" class="thumbnail text-center">
                    <img name="${image.name}" date="<fmt:formatDate value='${image.date}' pattern='yyyy-MM-dd HH:mm'/>" style="width: 140px; height: 130px;" src="http://p014k0k8b.bkt.clouddn.com/${image.url}"><!--这里请填写自己的链接地址，详见下图-->
...
<script src="//cdn.bootcss.com/bootstrap/3.3.7/js/bootstrap.js"></script><script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#upload').click(function() {
            if ($('#image_name').val() == '' || $('#image').val() == '') {
                ...
                $('#form').attr('action', '${pageContext.request.contextPath}' + '/image.do?type=1');
        ...
        //点击确定退出
        $('#exit').click(function() {
            $.get('${pageContext.request.contextPath}' + '/user.do?type=3', function(data, status) {
        ...
        $('#delete').click(function() {
            ...
            $.post('${pageContext.request.contextPath}' + '/image.do?type=2', {
                ids: ids,
                urls: urls
